...
On the backend, the annotation service is similarly designed for scalability and resilience. The annotators utilize polling mechanism and <a href="https://www.redhat.com/en/topics/automation/what-is-a-webhook">webhook pattern</a> along with Amazon **SNS and SQS**, with the latter requiring its own load balancer and auto scaling group respond to the depth of SQS (#number of pending annotation jobs). This design allows for timely job processing and graceful handling of user experience.
